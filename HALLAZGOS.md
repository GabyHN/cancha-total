...
`verificar.sh` termina en **0**. Los hallazgos #1, #2 y #3 están cerrados: sus pruebas pasan
sin marca. El hallazgo #4 sigue abierto, marcado como fallo esperado con su número, y la
