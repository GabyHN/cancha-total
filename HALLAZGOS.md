...
`verificar.sh` termina en **0**. El hallazgo #1 está cerrado: su prueba pasa sin marca. Los
hallazgos #2, #3 y #4 siguen abiertos, marcados como fallo esperado con su número, y la
prueba del #5 se omite sola cuando el reloj no permite construir el caso (de 09:00 en
adelante corre, y mientras el hallazgo siga abierto cae en su marca de fallo esperado).
